...
public interface functions extends Collection<function> {
	 ...
	 *            - the file name
	 * @throws IOException
	 *             if the file does not exists of unreadable (wrong format)
	 */
	 ...
	 * parameters for the GUI windo and the range & resolution
	 * 
	 * @param width
	 ...
	 * @param resolution
	 *            - the number of samples with in rx: the X_step = rx/resulution
	 */
	 ...
	 * 
	 * @param json_file
	 *            - the file with all the parameters for the GUI window. Note: is
	 *            the file id not readable or in wrong format should use default
	 *            values.
	 */
